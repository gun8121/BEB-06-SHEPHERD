...
const wellet = [
  "0x3400b8B75d6190436470dbD28384930AF57306c6",
  "0xeeE73652cFBd8Fb93Dcb5837c9651aBE3023c3Af",
  "0xE825E43CB0eF2992eb9ec46a99DA676e1B916a9c",
  "0xc18e01A3414E8A73AB6fFF23B7d2125f90dcCe44",
  "0xE572C6770F5754230D6687867BA04Ce9015eA010",
  "0xA6f80Ac2Bc36eF0629b2807bbc31E8e8c0a8B08F",
  "0x47a008BC326E277C1fABB3bd0c95bE5Ca9718Dc9",
  "0xCa278bb1900Cb4B28F7fe4D02b7B2fDE6313Baf6",
  "0x2310Dd5289B213daD085C9D63fa4cda7993b5475",
  "0x09A9bD56A993be517840f543936B6780E691Aeaf",
  "0xE5d998e62B2C9091BCF73dDdEC5757F13208E7A9",
  "0x33EA2dC389850F4F84aa060dD5413Bd61Fa1eEB8",
  "0x12d6ca24fD1dCceBF0cCA2cdb442666c16Bf30eC",
  "0x9654A5729d26A5ED6EcE4c9B50BB982AbC7745cE",
  "0x71dF357E40f65E5910E8F648E295F30F309c0Ed6",
  "0x214f556250dBf5b0f381Cb5fd855fD43cFAeFF83",
  "0x11fced3B9261593055E3d7c1A3561592b5b4fF02",
  "0xbe6bC9cDF8E318058d8893BCB33AbF153B2F2f29"
];

const mapBalance = async (req, res, next) => {

  // console.log(wellet[0]);
  // console.log(walletId[6].wallet);
  // const findZ = await contract.methods.balanceOf(findWallet, 0).call();
  // const findX = await contract.methods.balanceOf(findWallet, 1).call();
  // console.log(findZ);
  // console.log(findX);
  ...
  //     let resultdata = {};
  //     if ( walletId[i].wallet != null && walletId[i].id !=null) {
  //       resultdata["id"] = data[i].id;
  //       resultdata["wallet"] = data[i].wallet;
  //       return resultdata;
  //     }
